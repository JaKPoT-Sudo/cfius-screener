"""claude_memo.py — Claude Haiku drafts the screening memorandum narrative.

Claude writes ABOUT the engine's conclusions — it never makes its own legal
...
from screening_service import findings_of, mandatory_reasons_of, tid_categories_of
