"""Tests for the service layer, seed data, and web routes.

No test makes any network call — the app is fully self-contained in M1.
"""
...
from screening_service import findings_of, run_and_store
...
def test_unknown_screening_404():
    with TestClient(app) as client:
        assert client.get("/screening/99999").status_code == 404
