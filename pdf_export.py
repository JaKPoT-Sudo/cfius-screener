"""pdf_export.py — ReportLab PDF export for CFIUS screening memoranda.

Every page carries a diagonal DEMO watermark. The document contains:
...
from screening_service import findings_of
