"""claude_intake.py — Claude Haiku parses plain-English deal descriptions.

The caller (main.py) shows Claude's output on a confirmation screen before
the engine runs — Claude proposes, the human confirms. The engine never
knows whether facts arrived from this path or from the structured form.
"""
