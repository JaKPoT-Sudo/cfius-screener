...
stored result with full findings trail. No Claude calls yet — Milestone 2
adds plain-English intake (Claude parse + human confirmation) and the memo.
"""
...
def screening_detail(request: Request, screening_id: int, db: Session = Depends(get_db)):
